...
public class SntpClient {
    ...
    //android8.0
    private static final int TAG_SYSTEM_NTP = 0xFFFFFF41;
    ...
    public boolean requestTime(InetAddress address, int port, int timeoutMilliseconds) {
        DatagramSocket socket = null;
        // final int oldTag = TrafficStats.getAndSetThreadStatsTag(TAG_SYSTEM_NTP);
        try {
